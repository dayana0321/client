...
export class TbposicionesService {
  ...
  SaveTbposiciones(resultado: Object){
    return this.http.post(`${this.API_URI}/tbposiciones`, resultado, {headers:adminHeader()});
  }

  deleteTbposiciones(id:string){
    return this.http.delete(`${this.API_URI}/tbposiciones/${id}`, {headers:adminHeader()});
  }

  updateTbposiciones(id:string, updatedPais:Object){
    return this.http.put(`${this.API_URI}/tbposiciones/${id}`, updatedPais, {headers:adminHeader()} );
  }
}
